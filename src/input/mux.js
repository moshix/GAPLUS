 ...
 * `setSwitch` -- it just sets or clears a switch in the input state. That is fine while
...
/**
 * Switch names this can carry. These are exactly the names `setSwitch`
 * (src/input/switches.js) and `Machine.setInput` accept; the mux does not
 * validate them, it only routes.
 * @typedef {'coin1'|'coin2'|'service'|'start1'|'start2'|'fire1'|'fire2'
 *          |'up'|'down'|'left'|'right'
 *          |'p2up'|'p2down'|'p2left'|'p2right'} InputName
 */
